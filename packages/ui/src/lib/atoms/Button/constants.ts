...
export const BUTTON_VARIANTS: Record<ButtonVariant, string> = {
  ...
  gradientDuotone:
    'text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800',
  gradientOutline:
    'text-blue-700 hover:text-white border border-blue-700 hover:bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-gradient-to-r dark:from-blue-500 dark:via-blue-600 dark:to-blue-700 dark:focus:ring-blue-800'
}
...
export const BUTTON_BASE_CLASSES =
  'font-medium rounded-lg focus:outline-none inline-flex items-center justify-center'

export const BUTTON_LOADING_SPINNER = createElement(
  'svg',
  {
    'aria-hidden': 'true',
    role: 'status',
